...
| 2 | **Naviguer dans l'espace de travail Replit** | 2 h | Se repérer dans chaque panneau, comprendre les fichiers, la console et le shell.|
| 3 | **L'Agent Replit : prompts et itérations** | 3 h | Une application qui note les CV avec une grille explicite et une décision humaine finale. |
| 4 | **Preview, Console, Shell : exécuter et observer** | 3 h | Un pipeline pour générer des rapports et devis . |
| 5 | **Secrets, Database, fichiers et assets** | 3 h 30 | Un chatbot qui recherche avant de répondre, avec validation humaine avant tout envoi. |
